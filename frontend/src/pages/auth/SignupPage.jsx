    ...
    <div className="min-h-screen bg-mesh flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md animate-slide-up">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 text-sm mt-1">Start your 85%+ journey today — free forever</p>
        </div>
        ...
        <div className="glass-card p-8">
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 border border-white/10 rounded-xl py-3 px-4 text-sm font-medium text-slate-200 hover:bg-white/5 hover:border-white/20 transition-all mb-6 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 disabled:opacity-50 cursor-pointer"
          >
            <GoogleIcon />
          ...
          <form onSubmit={handleSubmit} className="space-y-4" noValidate>
            <Input label="Full Name" name="name" placeholder="Rahul Sharma" value={form.name}
              onChange={e => setForm(f => ({ ...f, name: e.target.value }))}
              error={errors.name} icon={User} required autoComplete="name" />
            ...
            <div className="relative">
              ...
              <button type="button" className="absolute right-3 bottom-3 text-slate-400 hover:text-slate-200"
            ...
            <Input label="Confirm Password" type="password" name="confirm"
              ...
              error={errors.confirm} icon={Lock} required autoComplete="new-password" />
          ...
          <p className="text-center text-xs text-slate-500 mt-4">
            ...
            <a href="/term" className="text-indigo-400 hover:underline">Terms</a> and{' '}
